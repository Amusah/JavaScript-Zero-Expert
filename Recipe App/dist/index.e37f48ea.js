...
var _webImmediateJs = require("core-js/modules/web.immediate.js"); // window.addEventListener('hashchange', displayRecipe);
...
eventArr.forEach((e)=>window.addEventListener(e, displayRecipe));
...
},{}]},["f0HGD","aenu9"], "aenu9", "parcelRequiree88c")
